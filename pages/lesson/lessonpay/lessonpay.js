...
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        wx.requestPayment({
          ...
          success: function () {
            that.viewBuy(wx.getStorageSync('user_id'),that.data.order_id);
  ...
  viewBuy(user_id,order_id){
    var dist_user_id = '';
    var that=this;
    if (app.globalData.dist.view_id == that.data.course_id) {
